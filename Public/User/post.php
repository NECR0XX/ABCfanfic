...
<body>
    ...
    <form action="post.php" method="post" enctype="multipart/form-data">
        ...
        <textarea name="text" cols="30" rows="10" placeholder="Escreva aqui sua história!" required></textarea>
        <textarea name="sinopse" cols="30" rows="10" placeholder="Sinopse da história" required></textarea>
