...
<head>
    ...
    <title>Lista de Fanfics de Suspense</title>
</head>
<body>
    <header>
        <div class="cabpri">
    ...
    <div class="container2">
            <h1 class= "tag2"><a href="../../landing.php">Abc fanfiction</h1></a> <h1 class= "tag"> > </h1> <h1 class= "tag2"><a href="../tags.php"> Tags </h1></a> <h1 class= "tag"> > </h1> <h1 class= "tag"> Suspense </h1>
    </div>
